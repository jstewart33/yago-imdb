...
m.add function:  "similar", 	name1   : Text,		name2   : Text, implementation: new LevenshteinSimilarity();
 ...
 */
H2DatabaseDriver h2 =
    new H2DatabaseDriver(H2DatabaseDriver.Memory, "memDB", false);
RDBMSDataStore data = new RDBMSDataStore(h2, null);
